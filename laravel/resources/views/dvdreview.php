...
<html>
	...
	<body> 
		...
		<div class="col-md-4">
			<?php if($dvdData): ?>
				<img src=" <?php echo $dvdData->posters->thumbnail ?> " > 
			<?php endif ?>
			...
			<?php if($dvdData): ?>
				<h5>Critics Score:</h5> <?php echo $dvdData->ratings->critics_score ?>
				<h5>Audience Score:</h5> <?php echo $dvdData->ratings->audience_score ?>
				<h5>Runtime:</h5> <?php echo $dvdData->runtime ?>
				<h5>Cast:</h5>
				<?php foreach ($dvdData->abridged_cast as $cast) : ?>
